  ...
  return (
    <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
            ...
            <div className="relative mb-4">
                <label htmlFor="password" className="leading-7 text-sm text-gray-600">Create your Password</label>
            ...
            <p className="text-xs text-gray-500 mt-3 text-center">Already Registered? <Link to={'/login'} className='text-indigo-500'>Login</Link></p>
            </div>
        </div>
    </section>
  )
